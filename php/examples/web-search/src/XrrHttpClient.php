...
namespace HopTop\StemExample\WebSearch;
...
/**
 * PSR-18 HTTP client that records every request through xrr.
 *
 * Same shape as the current-time variant — duplicated rather than
 * shared because each example is a standalone composer project so a
 * fresh checkout of any one example can be reasoned about in isolation.
 */
